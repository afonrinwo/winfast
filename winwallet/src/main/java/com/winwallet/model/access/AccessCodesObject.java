 ...
 */
@Entity
@Table(name = "Access_Code", uniqueConstraints = @UniqueConstraint(columnNames = { "msisdn" }))
public class AccessCodesObject implements Serializable {
	 ...
	 */
	public AccessCodesObject(long uniqueId, String msisdn, String hashText, LocalDateTime dateCreated,
