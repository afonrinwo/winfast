 ...
 *
 */
public class WalletDebitRequest implements Serializable {
	 ...
	 * @param narration
	 */
	public WalletDebitRequest(String clientId, String msisdn, String msisdnNetwork, String pin, double amount,
			String channel, String narration) {
		super();
