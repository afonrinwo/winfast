...
public class AgentCashOutRequest implements Serializable {
	 ...
	 * @param narration
	 */
	public AgentCashOutRequest(String clientId, String msisdn2Debit, String msisdn2DebitNetwork, String agentId2Credit,
			String agentId2CreditNetwork, String pin, double amount, String channel, String narration) {
		super();
