 ...
 */
@Entity
@Table(name = "System_Access", uniqueConstraints = @UniqueConstraint(columnNames = {"appId", "appKey", "serverIp"}))
public class SystemProfileObject implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2169360035126519015L;
