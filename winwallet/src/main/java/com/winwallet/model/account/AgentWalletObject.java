 ...
 */
@Entity
@Table(name = "Agent_Wallet", uniqueConstraints = @UniqueConstraint(columnNames = { "msisdn" }))
public class AgentWalletObject implements Serializable {
	 ...
	 */
	public AgentWalletObject(long uniqueId, String msisdn, String msisdnNetwork, double lien, int pnd,
